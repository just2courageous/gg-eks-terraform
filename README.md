...
Provision an **EKS [Elastic Kubernetes Service]** platform using **Terraform [Infrastructure as Code]**, then optionally add **Fluent Bit [Log shipper] → CloudWatch Logs [Amazon CloudWatch Logs]** with **IRSA [IAM Roles for Service Accounts]** and run a **HPA [Horizontal Pod Autoscaler] + PDB [Pod Disruption Budget]** reliability demo.

## 🎯 What this builds
* **VPC [Virtual Private Cloud]** with **public** and **private** subnets
* **NAT [Network Address Translation] Gateway** for private subnet egress
* **EKS [Elastic Kubernetes Service]** control plane
* **EKS [Elastic Kubernetes Service]** managed node group (worker nodes)
* **OIDC [OpenID Connect]** provider + **IRSA [IAM Roles for Service Accounts]** enabled
* **Control plane logs** to **CloudWatch Logs [Amazon CloudWatch Logs]**
* Optional: **Fluent Bit [Log shipper]** shipping cluster logs to **CloudWatch Logs [Amazon CloudWatch Logs]**
* Optional: **Reliability demo** using **HPA [Horizontal Pod Autoscaler]** and **PDB [Pod Disruption Budget]**
...
## ✅ Prerequisites
* **AWS CLI [Command Line Interface]** configured with a profile named `gg`
* **Terraform [Infrastructure as Code]**
* **kubectl [Kubernetes Command Line Tool]**
* **Helm [package manager]** (only for Fluent Bit [Log shipper] add on)
...
| Claim | Proof (click) |
| --- | --- |
| Terraform [Infrastructure as Code] apply completed | [terraform-apply-complete.png](docs/screenshots/terraform-apply-complete.png) |
...
| No AccessDenied (IRSA [IAM Roles for Service Accounts] working) | [p8-logging-06-fluentbit-no-denied.png](docs/screenshots/p8/p8-logging-06-fluentbit-no-denied.png) |
